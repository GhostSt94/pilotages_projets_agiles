...
![Diagramme 4](img/diagram-4.png)
*Figure 2.2 — Diagramme de séquence : calcul de la capacité d'un sprint.*

## 2.5 Règles métier et invariants

![Diagramme 5](img/diagram-5.png)
...
![Diagramme 10](img/diagram-10.png)
